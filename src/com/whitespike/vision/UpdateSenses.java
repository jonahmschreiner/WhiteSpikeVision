...
/**
 * Service method to update an env's senses using the newly discovered senses.
...
public class UpdateSenses {
	/**
	 * Service method to update an env's senses using the newly discovered senses.
	 * @param sensesIn Newly discovered senses passed in.
	 * @param oldEnvIn The env currently in the process of being updated.
	 * @return The env with updated senses.
	 */
